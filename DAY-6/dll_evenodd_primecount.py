...
class dll():
    ...
    def transfer(self):
        ...
        slow.t=t1
    def evenoddsum(self):
        temp=self.head          #even and odd sum difference using recursion
        if temp==None:
            return 0
        def method(temp,even_sum,odd_sum):
            if not temp:
            ...
            if temp.data%2==0:
                ...
                odd_sum+=temp.data
            return method(temp.next,even_sum,odd_sum)
        return method(temp,0,0)
    def count_prime(self):
        ...
        def method(temp,count):
            if not temp:
                return count
            if isprime(temp.data,2):
                count+=1
            return method(temp.next,count)
        return method(temp,0)
obj = dll()
obj.addfront(2)
obj.addfront(5)
obj.addfront(3)
...
#obj.transfer()
#obj.display()
# print(obj.evenoddsum())
print(obj.count_prime())